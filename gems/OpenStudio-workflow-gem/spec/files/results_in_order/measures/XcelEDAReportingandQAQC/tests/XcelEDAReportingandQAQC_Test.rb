...
class XcelEDAReportingandQAQC_Test < MiniTest::Unit::TestCase
  ...
  def idfPath
    return "#{File.dirname(__FILE__)}/0116_OfficeTest121_dev/run/4-EnergyPlusPreProcess-0/out.idf"
  end
  ...
  def resultsPath
    return "#{File.dirname(__FILE__)}/0116_OfficeTest121_dev/run/5-EnergyPlus-0/"
  end

  def sqlPath
    return "#{File.dirname(__FILE__)}/0116_OfficeTest121_dev/run/5-EnergyPlus-0/eplusout.sql"
  end
