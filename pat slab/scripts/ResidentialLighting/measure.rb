...
class ResidentialLighting < OpenStudio::Ruleset::ModelUserScript
  ...
  def arguments(model)
	...
	#make a choice argument for space type
    grg_space_type = OpenStudio::Ruleset::OSArgument::makeChoiceArgument("grg_space_type", space_type_handles, space_type_display_names)
	...
	#make a choice argument for space type
    fb_space_type = OpenStudio::Ruleset::OSArgument::makeChoiceArgument("fb_space_type", space_type_handles, space_type_display_names)
