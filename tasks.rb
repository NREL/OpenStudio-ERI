...
def set_hpxml_hvac_distributions(hpxml_file, hpxml)
  ...
  if ['RESNET_Tests/Other_HERS_AutoGen_Reference_Home_301_2014/01-L100.xml',
    ...
    hpxml.hvac_distributions[0].hvac_systems.each do |hvac_system|
  ...
  if hpxml.hvac_distributions.size == 1
    ...
    hpxml.hvac_distributions[0].number_of_return_registers = 1 # Arbitrary
  end
end
...
def create_sample_hpxmls
  ...
  include_list = ['invalid_files/dhw-frac-load-served.xml',
                  ...
                  'base-bldgtype-multifamily-shared-boiler-chiller-fan-coil.xml',
                  ...
                  'base-bldgtype-multifamily-shared-boiler-cooling-tower-water-loop-heat-pump.xml',
                  ...
                  'base-bldgtype-multifamily-shared-boiler-only-fan-coil-eae.xml',
                  ...
                  'base-bldgtype-multifamily-shared-mechvent-multiple.xml',
                  ...
                  'base-dhw-recirc-manual.xml',
                  'base-dhw-recirc-nocontrol.xml',
                  'base-dhw-recirc-temperature.xml',
                  'base-dhw-recirc-timer.xml',
                  'base-dhw-solar-direct-evacuated-tube.xml',
                  'base-dhw-solar-direct-flat-plate.xml',
                  'base-dhw-solar-direct-ics.xml',
                  ...
                  'base-hvac-install-quality-all-furnace-gas-central-ac-var-speed.xml',
  ...
  hpxml_paths.each do |hpxml_path|
    ...
    (hpxml.heating_systems + hpxml.cooling_systems + hpxml.heat_pumps).each do |hvac_system|
      if hvac_system.distribution_system.nil?
        ...
        if hvac_system.distribution_system.distribution_system_type == HPXML::HVACDistributionTypeAir
          if hvac_system.distribution_system.ducts.select { |d| d.duct_location != HPXML::LocationLivingSpace && d.duct_location != HPXML::LocationBasementConditioned }.size > 0
            hvac_system.distribution_system.hvac_systems.each do |hvac_system|
              hvac_system.location = HPXML::LocationUnconditionedSpace
            end
          else
            hvac_system.distribution_system.hvac_systems.each do |hvac_system|
