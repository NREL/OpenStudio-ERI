  ...
  hpxmls_files.each do |derivative, parent|
    ...
    begin
      ...
      hpxml_files.each do |hpxml_file|
        ...
        set_hpxml_air_infiltration_measurement(hpxml_file, hpxml)
        set_hpxml_attic(hpxml_file, hpxml)
        set_hpxml_foundation(hpxml_file, hpxml)
        ...
        set_hpxml_framefloors(hpxml_file, hpxml)
        ...
        set_hpxml_ventilation_fan(hpxml_file, hpxml)
        set_hpxml_water_heating_system(hpxml_file, hpxml)
        set_hpxml_hot_water_distribution(hpxml_file, hpxml)
        set_hpxml_water_fixtures(hpxml_file, hpxml)
        set_hpxml_pv_system(hpxml_file, hpxml)
        ...
        set_hpxml_ceiling_fan(hpxml_file, hpxml)
...
def set_hpxml_building_occupancy(hpxml_file, hpxml)
  if hpxml_file.include? 'RESNET_Tests/4.1_Standard_140' or
     ...
     hpxml_file.include? 'RESNET_Tests/4.5_DSE'
    # Base configuration
    hpxml.building_occupancy = HPXML::BuildingOccupancy.new({ :number_of_residents => 0 })
  else
...
def set_hpxml_building_construction(hpxml_file, hpxml)
  if ['RESNET_Tests/4.1_Standard_140/L100AC.xml',
      'RESNET_Tests/4.1_Standard_140/L100AL.xml'].include? hpxml_file
    # Base configuration
    hpxml.building_construction = HPXML::BuildingConstruction.new({ :number_of_conditioned_floors => 1,
...
def set_hpxml_climate_and_risk_zones(hpxml_file, hpxml)
  if hpxml_file == 'RESNET_Tests/4.1_Standard_140/L100AC.xml'
    ...
    # Las Vegas
    hpxml.climate_and_risk_zones = HPXML::ClimateandRiskZones.new({ :iecc2006 => "3B",
                                                                    :weather_station_id => "WeatherStation",
...
def set_hpxml_air_infiltration_measurement(hpxml_file, hpxml)
  if ['RESNET_Tests/4.1_Standard_140/L100AC.xml',
...
def set_hpxml_attic(hpxml_file, hpxml)
  if hpxml_file.include? 'RESNET_Tests/4.1_Standard_140' or
     hpxml_file.include? 'RESNET_Tests/4.4_HVAC' or
     hpxml_file.include? 'RESNET_Tests/4.5_DSE'
    # Base configuration
...
def set_hpxml_foundation(hpxml_file, hpxml)
...
def set_hpxml_roofs(hpxml_file, hpxml)
  if ['RESNET_Tests/4.1_Standard_140/L100AC.xml',
      'RESNET_Tests/4.1_Standard_140/L100AL.xml'].include? hpxml_file
    # Base configuration
    hpxml.roofs = [HPXML::Roof.new({ :id => "AtticRoofNorth",
                   ...
                   HPXML::Roof.new({ :id => "AtticRoofSouth",
                                     :interior_adjacent_to => "attic - vented",
                                     :area => 811.1,
                                     :azimuth => 180,
                                     :solar_absorptance => 0.6,
...
def set_hpxml_rim_joists(hpxml_file, hpxml)
  if ['RESNET_Tests/4.1_Standard_140/L322XC.xml'].include? hpxml_file
    ...
    hpxml.rim_joists = [HPXML::RimJoist.new({ :id => "RimJoistNorth",
                        ...
                        HPXML::RimJoist.new({ :id => "RimJoistEast",
                                              :exterior_adjacent_to => "outside",
                                              :interior_adjacent_to => "basement - conditioned",
                                              :area => 20.25,
                                              :azimuth => 90,
                                              ...
                                              :emittance => 0.9,
                                              :insulation_assembly_r_value => 5.01 }),
                        HPXML::RimJoist.new({ :id => "RimJoistSouth",
                                              :exterior_adjacent_to => "outside",
                                              :interior_adjacent_to => "basement - conditioned",
                                              :area => 42.75,
                                              :azimuth => 180,
                                              ...
                                              :emittance => 0.9,
                                              :insulation_assembly_r_value => 5.01 }),
                        HPXML::RimJoist.new({ :id => "RimJoistWest",
                                              :exterior_adjacent_to => "outside",
                                              :interior_adjacent_to => "basement - conditioned",
                                              :area => 20.25,
                                              :azimuth => 270,
...
def set_hpxml_walls(hpxml_file, hpxml)
  if ['RESNET_Tests/4.1_Standard_140/L100AC.xml',
      'RESNET_Tests/4.1_Standard_140/L100AL.xml'].include? hpxml_file
    # Base configuration
    hpxml.walls = [HPXML::Wall.new({ :id => "WallNorth",
                                     :exterior_adjacent_to => "outside",
                   ...
                   HPXML::Wall.new({ :id => "WallWest",
                                     ...
                                     :emittance => 0.9,
                                     :insulation_assembly_r_value => 11.76 }),
                   HPXML::Wall.new({ :id => "WallAtticGableEast",
                                     :exterior_adjacent_to => "outside",
                                     :interior_adjacent_to => "attic - vented",
                                     :wall_type => "WoodStud",
                                     :area => 60.75,
                   ...
                   HPXML::Wall.new({ :id => "WallAtticGableWest",
                                     :exterior_adjacent_to => "outside",
                                     :interior_adjacent_to => "attic - vented",
                                     :wall_type => "WoodStud",
                                     :area => 60.75,
...
def set_hpxml_foundation_walls(hpxml_file, hpxml)
  if ['RESNET_Tests/4.1_Standard_140/L100AC.xml',
    ...
    # Uninsulated ASHRAE Conditioned Basement
    hpxml.foundation_walls = [HPXML::FoundationWall.new({ :id => "FoundationWallNorth",
                              ...
                              HPXML::FoundationWall.new({ :id => "FoundationWallEast",
                                                          :exterior_adjacent_to => "ground",
                                                          :interior_adjacent_to => "basement - conditioned",
                                                          :height => 7.25,
                                                          :area => 195.75,
                                                          ...
                                                          :insulation_exterior_distance_to_top => 0,
                                                          :insulation_exterior_distance_to_bottom => 0 }),
                              HPXML::FoundationWall.new({ :id => "FoundationWallSouth",
                                                          :exterior_adjacent_to => "ground",
                                                          :interior_adjacent_to => "basement - conditioned",
                                                          :height => 7.25,
                                                          :area => 413.25,
                                                          ...
                                                          :insulation_exterior_distance_to_top => 0,
                                                          :insulation_exterior_distance_to_bottom => 0 }),
                              HPXML::FoundationWall.new({ :id => "FoundationWallWest",
                                                          :exterior_adjacent_to => "ground",
                                                          :interior_adjacent_to => "basement - conditioned",
                                                          :height => 7.25,
                                                          :area => 195.75,
    ...
    for i in 0..hpxml.foundation_walls.size - 1
      hpxml.foundation_walls[i].interior_adjacent_to = "basement - unconditioned"
    end
  end
end

def set_hpxml_framefloors(hpxml_file, hpxml)
  if ['RESNET_Tests/4.1_Standard_140/L100AC.xml',
      'RESNET_Tests/4.1_Standard_140/L100AL.xml',
      'RESNET_Tests/4.5_DSE/HVAC3a.xml'].include? hpxml_file
    # Base configuration
    hpxml.frame_floors = [HPXML::FrameFloor.new({ :id => "FloorUnderAttic",
                                                  :exterior_adjacent_to => "attic - vented",
                                                  :interior_adjacent_to => "living space",
                                                  :area => 1539,
                                                  :insulation_assembly_r_value => 18.45 }),
                          HPXML::FrameFloor.new({ :id => "FloorOverFoundation",
                                                  :exterior_adjacent_to => "outside",
                                                  :interior_adjacent_to => "living space",
                                                  :area => 1539,
                                                  :insulation_assembly_r_value => 14.15 })]
    if ['RESNET_Tests/4.5_DSE/HVAC3a.xml'].include? hpxml_file
      hpxml.frame_floors[1].exterior_adjacent_to = "basement - unconditioned"
    end
  elsif ['RESNET_Tests/4.1_Standard_140/L120AC.xml',
         'RESNET_Tests/4.1_Standard_140/L120AL.xml'].include? hpxml_file
    ...
    # Uninsulated
    hpxml.frame_floors[1].insulation_assembly_r_value = 4.24
    hpxml.frame_floors[1].exterior_adjacent_to = "crawlspace - unvented"
    ...
    hpxml.frame_floors[1].exterior_adjacent_to = "crawlspace - vented"
...
def set_hpxml_windows(hpxml_file, hpxml)
  if ['RESNET_Tests/4.1_Standard_140/L100AC.xml',
    ...
    windows.each do |window_name, window_values|
      ...
      hpxml.windows << HPXML::Window.new({ :id => window_name,
                                           :area => area,
                                           :azimuth => azimuth,
                                           :ufactor => 1.039,
                                           :shgc => 0.67,
    ...
    # South windows only
    hpxml.windows = [HPXML::Window.new({ :id => "WindowSouth",
                                         :area => 270,
                                         :azimuth => 180,
                                         :ufactor => 1.039,
                                         :shgc => 0.67,
...
def set_hpxml_doors(hpxml_file, hpxml)
  if ['RESNET_Tests/4.1_Standard_140/L100AC.xml',
    ...
    doors.each do |door_name, door_values|
      ...
      hpxml.doors << HPXML::Door.new({ :id => door_name,
                                       :wall_idref => wall,
                                       :area => area,
                                       :azimuth => azimuth,
                                       :r_value => 3.04 })
...
def set_hpxml_hvac_distributions(hpxml_file, hpxml)
  ...
  if ['RESNET_Tests/4.2_HERS_AutoGen_Reference_Home/01-L100.xml',
    ...
    for i in 0..hpxml.hvac_distributions[0].ducts.size - 1
      hpxml.hvac_distributions[0].ducts[i].duct_location = "basement - unconditioned"
    end
    ...
    for i in 0..hpxml.hvac_distributions[0].ducts.size - 1
      hpxml.hvac_distributions[0].ducts[i].duct_location = "attic - vented"
    end
    ...
    for i in 0..hpxml.hvac_distributions[0].ducts.size - 1
      hpxml.hvac_distributions[0].ducts[i].duct_location = "crawlspace - vented"
    end
  elsif ['RESNET_Tests/Other_HERS_Method_Task_Group/L100A-CO-07.xml',
         'RESNET_Tests/Other_HERS_Method_Task_Group/L100A-LV-07.xml'].include? hpxml_file
    ...
    for i in 0..hpxml.hvac_distributions[0].ducts.size - 1
      hpxml.hvac_distributions[0].ducts[i].duct_insulation_r_value = 6
      hpxml.hvac_distributions[0].ducts[i].duct_location = "outside"
    end
...
def set_hpxml_ventilation_fan(hpxml_file, hpxml)
  if hpxml_file.include? 'RESNET_Tests/4.1_Standard_140' or
     hpxml_file.include? 'RESNET_Tests/4.4_HVAC' or
     hpxml_file.include? 'RESNET_Tests/4.5_DSE'
    # Base configuration
...
def set_hpxml_water_heating_system(hpxml_file, hpxml)
  if hpxml_file.include? 'RESNET_Tests/4.1_Standard_140' or
     hpxml_file.include? 'RESNET_Tests/4.4_HVAC' or
     hpxml_file.include? 'RESNET_Tests/4.5_DSE'
    # Base configuration
...
def set_hpxml_hot_water_distribution(hpxml_file, hpxml)
  ...
  hpxml.foundation_walls.each do |foundation_wall|
    next unless [foundation_wall.interior_adjacent_to, foundation_wall.exterior_adjacent_to].include? "basement - unconditioned"
...
def set_hpxml_pv_system(hpxml_file, hpxml)
end
...
def set_hpxml_lighting(hpxml_file, hpxml)
  if hpxml_file.include? 'RESNET_Tests/4.1_Standard_140' or
    ...
    hpxml.lighting = HPXML::Lighting.new({ :fraction_tier_i_interior => 0.75,
    ...
    hpxml.lighting = HPXML::Lighting.new({ :fraction_tier_i_interior => fFI_int,
...
def set_hpxml_ceiling_fan(hpxml_file, hpxml)
end
