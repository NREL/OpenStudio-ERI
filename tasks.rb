...
def set_hpxml_header(hpxml_file, hpxml, hpxml_bldg, orig_parent)
  ...
  if hpxml_file.include?('RESNET_Tests/Other_Hot_Water_301_2014_PreAddendumA')
    ...
    if hpxml_file.include?('SF_National_3.2')
      hpxml.header.energystar_calculation_versions = [ES::SFNationalVer3_2]
    elsif hpxml_file.include?('SF_National_3.1')
      hpxml.header.energystar_calculation_versions = [ES::SFNationalVer3_1]
    elsif hpxml_file.include?('SF_National_3.0')
      hpxml.header.energystar_calculation_versions = [ES::SFNationalVer3_0]
    elsif hpxml_file.include?('MF_National_1.2')
      hpxml.header.energystar_calculation_versions = [ES::MFNationalVer1_2]
    elsif hpxml_file.include?('MF_National_1.1')
      hpxml.header.energystar_calculation_versions = [ES::MFNationalVer1_1]
    elsif hpxml_file.include?('MF_National_1.0')
      hpxml.header.energystar_calculation_versions = [ES::MFNationalVer1_0]
    end
...
def create_sample_hpxmls
  ...
  hpxml_paths.each do |hpxml_path|
    ...
    if hpxml_path.include? 'base-bldgtype-mf-unit'
      hpxml.header.zerh_calculation_versions = [ZERH::MFVer2]
    else
      hpxml.header.zerh_calculation_versions = [ZERH::SFVer2]
    end
    if hpxml_path.include? 'base-bldgtype-mf-unit'
      hpxml.header.energystar_calculation_versions = [ES::MFNationalVer1_2]
    elsif hpxml_bldg.state_code == 'FL'
      hpxml.header.energystar_calculation_versions = [ES::SFFloridaVer3_1]
    elsif hpxml_bldg.state_code == 'HI'
      hpxml.header.energystar_calculation_versions = [ES::SFPacificVer3_0]
    elsif hpxml_bldg.state_code == 'OR'
      hpxml.header.energystar_calculation_versions = [ES::SFOregonWashingtonVer3_2]
    else
      hpxml.header.energystar_calculation_versions = [ES::SFNationalVer3_2]
    end
  ...
  hpxml_bldg = hpxml.buildings[0]
  hpxml.header.energystar_calculation_versions = [ES::MFOregonWashingtonVer1_2]
