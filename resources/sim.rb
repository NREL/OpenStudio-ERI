...
def _addInsulatedSheathingMaterial(rigidInsThickness, rigidInsRvalue)
    ...
    rigid_thick = OpenStudio::convert(rigidInsThickness,"in","ft").get # ft
    if rigidInsRvalue == 0
        rigid_cond = 99999
    else
...
def get_wood_stud_wall_r_assembly(wallCavityInsFillsCavity, wallCavityInsRvalueInstalled, 
                              wallInstallGrade, wallCavityDepth, wallFramingFactor, 
                              prefix, gypsumThickness, gypsumNumLayers, finishThickness, 
                              finishConductivty, rigidInsThickness=0, rigidInsRvalue=0, hasOSB=true)
