module OsLib_Geometry
  ...
  # currently takes in model and checks for edges shared by a ground exposed floor and exterior exposed wall. Later coudld be updated for a specific story independent of floor boundary condition.
