...
def _get_internal_gains(hpxml_bldg, eri_version)
  ...
  cr_annual_kwh, cr_annual_therm, cr_frac_sens, cr_frac_lat = HPXMLDefaults.calc_range_oven_energy(nbeds, cooking_range, oven)
  ...
  rf_annual_kwh, rf_frac_sens, rf_frac_lat = HPXMLDefaults.calc_fridge_or_freezer_energy(refrigerator)
  ...
  dw_annual_kwh, dw_frac_sens, dw_frac_lat, _dw_gpd = HPXMLDefaults.calc_dishwasher_energy_gpd(eri_version, nbeds, dishwasher)
  ...
  cw_annual_kwh, cw_frac_sens, cw_frac_lat, _cw_gpd = HPXMLDefaults.calc_clothes_washer_energy_gpd(eri_version, nbeds, clothes_washer)
  ...
  cd_annual_kwh, cd_annual_therm, cd_frac_sens, cd_frac_lat = HPXMLDefaults.calc_clothes_dryer_energy(eri_version, nbeds, clothes_dryer, clothes_washer)
