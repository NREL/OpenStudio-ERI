...
def run_design(design, debug, timeseries_output_freq, timeseries_outputs, add_comp_loads, generate_diagnostic_output)
...
if ARGV.size == 9
  ...
  enerate_diagnostic_output = (ARGV[8].downcase.to_s == 'true')
  run_design(design, debug, timeseries_output_freq, timeseries_outputs, add_comp_loads, enerate_diagnostic_output)
end
