...
class ProcessFurnacePropaneTest < MiniTest::Test 
  ...
  def test_new_construction_fbsmt_afue_0_78
    ...
    expected_values = {"Efficiency"=>0.78, "NominalCapacity"=>5861.42, "MaximumSupplyAirTemperature"=>48.88, "FuelType"=>Constants.FuelTypePropane}
  ...
  def _test_measure(osm_file_or_model, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, num_infos=0, num_warnings=0, debug=false)
    ...
    measure = ProcessFurnacePropane.new
