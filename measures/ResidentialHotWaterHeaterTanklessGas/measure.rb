...
class ResidentialHotWaterHeaterTanklessGas < OpenStudio::Ruleset::ModelUserScript
    ...
    def run(model, runner, user_arguments)
        ...
        (1..num_units).to_a.each do |unit_num|
            ...
            new_heater = Waterheater.create_new_heater(Constants.ObjectNameWaterHeater(unit_num), cap, Constants.FuelTypeGas, 1, nbeds, nbaths, ef, 0, t_set, water_heater_tz, oncycle_p, offcycle_p, tanktype, cd, model, runner)
