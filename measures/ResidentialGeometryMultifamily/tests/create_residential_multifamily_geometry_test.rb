...
class CreateResidentialMultifamilyGeometryTest < MiniTest::Test
  ...
  def test_warning_uneven_units_per_floor_with_interior_corr
    ...
    expected_values = {"FinishedFloorArea"=>900*2}
  ...
  def test_two_story_double_exterior
    ...
    expected_values = {"FinishedFloorArea"=>900*2*4}
  ...
  def test_multiplex_right_inset
    ...
    expected_values = {"FinishedFloorArea"=>900*8*6, "UnfinishedBasementHeight"=>8}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)   
  end  
  ...
  def test_crawl_single_exterior
    ...
    expected_values = {"FinishedFloorArea"=>900*2*12, "CrawlspaceHeight"=>3}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)    
  end  
  ...
  def test_crawlspace_double_loaded_corr
    ...
    expected_values = {"FinishedFloorArea"=>900*1*4, "CrawlspaceHeight"=>3}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)      
  end  
  ...
  def test_ufbasement_double_loaded_corr
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"BuildingUnit"=>1*4, "Surface"=>52, "ThermalZone"=>1*4+1+1, "Space"=>1*4+1+1}
    expected_values = {"FinishedFloorArea"=>900*1*4, "UnfinishedBasementHeight"=>8}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)      
  end     
  ...
  def test_zone_mult_front_units_only
    ...
    expected_values = {"FinishedFloorArea"=>900*3}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)    
  end  
  ...
  def test_zone_mult_with_rear_units_even
    ...
    expected_values = {"FinishedFloorArea"=>900*6}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)  
  end
  ...
  def test_floor_mult
    ...
    expected_values = {"FinishedFloorArea"=>900*24}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)    
  end
  ...
  def test_two_units_per_floor_with_rear_units
    ...
    expected_values = {"FinishedFloorArea"=>900*8}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)  
  end  
  ...
  def test_one_unit_per_floor_with_no_rear_units
    ...
    expected_values = {"FinishedFloorArea"=>900*4}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end    
  ...
  def _test_measure(osm_file_or_model, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, num_infos=0, num_warnings=0, debug=false)
    ...
    actual_values = {"FinishedFloorArea"=>0, "UnfinishedBasementHeight"=>0, "CrawlspaceHeight"=>0}
