...
class NewMeasureTest < MiniTest::Test
  ...
  def test_new_construction_none1
    ...
    _test_new_construction("005Chicago_2story_3000_FB_UA_Grg_c.osm", args_hash, false)
  end
  ...
  def test_new_construction_ef_17_6
    ...
    _test_new_construction("005Chicago_2story_3000_FB_UA_Grg_c.osm", args_hash, true, 434.0)
  end
  ...
  def test_new_construction_ef_17_6_mult_0_95
    ...
    args_hash["fridge_E"] = 434.0
    args_hash["mult"] = 0.95
    _test_new_construction("005Chicago_2story_3000_FB_UA_Grg_c.osm", args_hash, true, 412.3)
  end
  ...
  def test_new_construction_ef_17_6_mult_1_05
    ...
    args_hash["fridge_E"] = 434.0
    args_hash["mult"] = 1.05
    _test_new_construction("005Chicago_2story_3000_FB_UA_Grg_c.osm", args_hash, true, 455.7)
  end
  
  def test_new_construction_ef_17_6_modified_schedule
    args_hash = {}
    args_hash["fridge_E"] = 434.0
  ...
  def test_retrofit_replace
    args_hash = {}
    args_hash["fridge_E"] = 434.0
    model = _test_new_construction("005Chicago_2story_3000_FB_UA_Grg_c.osm", args_hash, true, 434.0)
    args_hash = {}
  ...
  def test_argument_error_fridge_E_negative
    ...
    _test_error("005Chicago_2story_3000_FB_UA_Grg_c.osm", args_hash)
  end
  ...
  def _test_new_construction(osm_file, args_hash, expected_new_object, expected_annual_kwh=nil)
    ...
    if expected_new_object
        ...
        # check for the correct annual kWh energy consumption
        full_load_hrs = Schedule.annual_equivalent_full_load_hrs(model, new_object.schedule.get)
        actual_annual_kwh = full_load_hrs * new_object.designLevel.get/1000 * new_object.multiplier
