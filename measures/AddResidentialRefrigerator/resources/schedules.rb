class Schedule
    def initialize(weekday_hourly_values, weekend_hourly_values, monthly_values, runner)
		@validated = true
	...
	def calcDesignLevel(energy_kwh)
		return energy_kwh * @maxval * 1000 * @schadjust
	end
  
    def createSchedule(model, sch_name)
		wkdy = []
		wknd = []
