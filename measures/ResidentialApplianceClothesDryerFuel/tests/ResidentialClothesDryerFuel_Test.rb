...
class ResidentialClothesDryerFuelTest < MiniTest::Test
  ...
  def test_multifamily_new_construction
    ...
    expected_values = {"Annual_kwh"=>229.5, "Annual_therm"=>104.1, "Annual_gal"=>0, "FuelType"=>Constants.FuelTypeGas, "Space"=>args_hash["space"]}
  ...
  def test_multifamily_retrofit_replace
    ...
    expected_num_new_objects = {"ElectricEquipmentDefinition"=>num_units, "ElectricEquipment"=>num_units, "OtherEquipmentDefinition"=>num_units, "OtherEquipment"=>num_units, "ScheduleRuleset"=>1}
    expected_values = {"Annual_kwh"=>181.2, "Annual_therm"=>82.2, "Annual_gal"=>0, "FuelType"=>Constants.FuelTypeGas, "Space"=>args_hash["space"]}
