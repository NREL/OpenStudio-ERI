  ...
  def self.add_airflow(runner, model, building, unit)
    ...
    if not air_distribution.nil?
      ...
      if duct_supply_location != duct_return_location
        fail "ERROR: Multiple duct locations currently unsupported."
      end
    else
    ...
    ducts = Ducts.new(nil, duct_supply_leakage_cfm25, nil, duct_return_leakage_cfm25, duct_supply_area, duct_return_area, 
                      duct_supply_r, duct_return_r, duct_supply_location)
