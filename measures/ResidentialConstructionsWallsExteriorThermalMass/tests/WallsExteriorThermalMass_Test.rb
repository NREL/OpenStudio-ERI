...
class ProcessConstructionsWallsExteriorThermalMassTest < MiniTest::Test
  ...
  def test_add_2_of_5_8in_drywall
    ...
    expected_values = {"LayerThickness"=>0.015875*2, "LayerConductivity"=>0.16029*2, "LayerDensity"=>801*2, "LayerSpecificHeat"=>837.4*2, "LayerIndex"=>0+1}
    _test_measure(osm_geo, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_add_2_of_1_2in_drywall_to_layers_and_replace_with_5_8in_drywall
    ...
    expected_num_new_objects = {"Material"=>2, "Construction"=>1}
    expected_values = {"LayerThickness"=>0.0127*2, "LayerConductivity"=>0.16029*2, "LayerDensity"=>801*2, "LayerSpecificHeat"=>837.4*2, "LayerIndex"=>3+4}
    ...
    expected_num_new_objects = {"Material"=>1, "Construction"=>1}
    expected_values = {"LayerThickness"=>0.015875, "LayerConductivity"=>0.16029, "LayerDensity"=>801, "LayerSpecificHeat"=>837.4, "LayerIndex"=>3}
