...
class ProcessTwoSpeedAirSourceHeatPumpTest < MiniTest::Test  
  ...
  def test_new_construction_fbsmt_seer_16_8pt6_hspf
    ...
    expected_values = {"CoolingCOP"=>[4.16, 3.69], "HeatingCOP"=>[3.97, 3.43], "CoolingNominalCapacity"=>[OpenStudio::convert(3.0,"ton","W").get]*2, "HeatingNominalCapacity"=>[OpenStudio::convert(3.0,"ton","W").get]*2, "MaximumSupplyAirTemperature"=>76.66, "hvac_priority"=>1}
