...
class ProcessFurnaceTest < MiniTest::Test 
  ...
  def test_new_construction_afue_0_78
    ...
    expected_values = {"supplemental_efficiency"=>0.78, "NominalCapacity"=>"AutoSize", "MaximumSupplyAirTemperature"=>48.88}
  ...
  def test_new_construction_fbsmt_afue_0_78
    ...
    expected_values = {"supplemental_efficiency"=>0.78, "NominalCapacity"=>5861.42, "MaximumSupplyAirTemperature"=>48.88}
  ...
  def test_new_construction_afue_1
    ...
    expected_values = {"supplemental_efficiency"=>1, "NominalCapacity"=>2*5861.42, "MaximumSupplyAirTemperature"=>48.88}
    _test_measure("singlefamily_detached.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 3)
  end
    ...
    all_new_objects.each do |obj_type, new_objects|
        new_objects.each do |new_object|
            ...
            if obj_type == "AirLoopHVACUnitarySystem"
                ...
                assert_in_epsilon(expected_values["supplemental_efficiency"], new_object.gasBurnerEfficiency, 0.01)
                ...
                assert_in_epsilon(expected_values["supplemental_efficiency"], new_object.efficiency, 0.01)
                if new_object.nominalCapacity.is_initialized
                  assert_in_epsilon(expected_values["NominalCapacity"], new_object.nominalCapacity.get, 0.01)
                end
            end
