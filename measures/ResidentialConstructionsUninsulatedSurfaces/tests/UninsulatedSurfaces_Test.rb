...
class ProcessConstructionsUninsulatedSurfacesTest < MiniTest::Test
  ...
  def test_apply_to_specific_attic_wall_surface
    ...
    expected_values = {"LayerThickness"=>0.0889+0.0127, "LayerConductivity"=>0.393681034808728+0.1154577, "LayerDensity"=>83.0261176588975+512.64, "LayerSpecificHeat"=>1211.61631295919+1214.23, "LayerIndex"=>0+1, "SurfacesWithConstructions"=>1}
  ...
  def test_apply_to_specific_adiabatic_floor_surface
    ...
    expected_values = {"LayerThickness"=>0.1397, "LayerConductivity"=>0.557309177988857, "LayerDensity"=>67.6397079287161, "LayerSpecificHeat"=>1211.145732766076, "LayerIndex"=>0, "SurfacesWithConstructions"=>2}
    _test_measure(osm_geo, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)  
  end  
