...
class ProcessCoolingSetpointsTest < MiniTest::Test
  ...
  def test_wkdy_wked_are_different
    ...
    expected_values = {}
    _test_measure("singlefamily_detached_central_air_conditioner.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 5)
  end  
  ...
  def test_air_source_heat_pump
    ...
    expected_num_new_objects = {"ScheduleRule"=>36, "ScheduleRuleset"=>3, "ThermostatSetpointDualSetpoint"=>1}
    expected_values = {}
    _test_measure("singlefamily_detached_ashp.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 5)
  end
  ...
  def test_retrofit_replace
    ...
    expected_num_new_objects = {"ScheduleRule"=>36, "ScheduleRuleset"=>3, "ThermostatSetpointDualSetpoint"=>1}
    expected_values = {}
    model = _test_measure("singlefamily_detached_central_air_conditioner.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 5)
  ...
  def test_heating_setpoints_exist
    ...
    expected_num_new_objects = {"ScheduleRule"=>36, "ScheduleRuleset"=>3}
    expected_values = {}
    _test_measure("singlefamily_detached_central_air_conditioner_furnace_heating_setpoints.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 4)
  end  
