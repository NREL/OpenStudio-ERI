...
#start the measure
class ProcessFurnaceOil < OpenStudio::Ruleset::ModelUserScript
  ...
  def name
    return "Set Residential Furnace Oil"
  end
  ...
  def run(model, runner, user_arguments)
    ...
    units.each do |unit|
      ...
      control_slave_zones_hash.each do |control_zone, slave_zones|
        ...
        htg_coil.setFuelType(HelperMethods.eplus_fuel_map(Constants.FuelTypeOil))
...
ProcessFurnaceOil.new.registerWithApplication