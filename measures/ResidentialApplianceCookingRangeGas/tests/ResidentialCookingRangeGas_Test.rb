...
class ResidentialCookingRangeGasTest < MiniTest::Test
  ...
  def test_argument_error_c_ef_lt_0
    ...
    assert_equal(result_errors(result)[0], "Cooktop energy factor must be greater than 0 and less than or equal to 1.")
  end
  ...
  def test_argument_error_o_ef_lt_0
    ...
    args_hash["o_ef"] = -1.0
    result = _test_error(osm_geo_beds, args_hash)
    assert_equal(result_errors(result)[0], "Oven energy factor must be greater than 0 and less than or equal to 1.")
  end
