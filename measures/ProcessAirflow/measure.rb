...
#load sim.rb
require "C:/OpenStudio-BEopt/OpenStudio-Beopt/resources/sim"
...
class ProcessAirflow < OpenStudio::Ruleset::WorkspaceUserScript
  ...
  def arguments(workspace)
    ...
    userdefined_infsheltercoef = OpenStudio::Ruleset::OSArgument::makeStringArgument("userdefinedinfsheltercoef", true)
    ...
    selected_venttype.setDefaultValue("none")
    ...
    userdefined_totaleff.setDefaultValue(0.0)
    ...
    userdefined_senseff.setDefaultValue(0.6)
    ...
    userdefined_ventweekenddays.setDisplayName("FNumber of weekend days in the week that natural ventilation can occur.")
  ...
  def run(workspace, runner, user_arguments)
    ...
    dryerExhaust = 100.0 # tk get this
    ...
    zones.each do |zone|
      ...
      if zone_name == selected_living
        ...
        living_space.area = OpenStudio::convert(zone.getString(9).get.to_f,"m","ft").get # Floor Area {m2}
        living_space.volume = OpenStudio::convert(zone.getString(8).get.to_f,"m^3","ft^3").get # Volume {m3}
        living_space.coord_z = OpenStudio::convert(zone.getString(4).get.to_f,"m^3","ft^3").get # Z Origin {m}
      elsif zone_name == selected_garage
        garage.height = OpenStudio::convert(zone.getString(7).get.to_f,"m","ft").get # Ceiling Height {m}
        garage.area = OpenStudio::convert(zone.getString(9).get.to_f,"m","ft").get # Floor Area {m2}
        garage.volume = OpenStudio::convert(zone.getString(8).get.to_f,"m^3","ft^3").get # Volume {m3}
        garage.coord_z = OpenStudio::convert(zone.getString(4).get.to_f,"m^3","ft^3").get # Z Origin {m}
        ...
        finished_basement.area = OpenStudio::convert(zone.getString(9).get.to_f,"m","ft").get # Floor Area {m2}
        finished_basement.volume = OpenStudio::convert(zone.getString(8).get.to_f,"m^3","ft^3").get # Volume {m3}
        finished_basement.coord_z = OpenStudio::convert(zone.getString(4).get.to_f,"m^3","ft^3").get # Z Origin {m}
        ...
        space_unfinished_basement.area = OpenStudio::convert(zone.getString(9).get.to_f,"m","ft").get # Floor Area {m2}
        space_unfinished_basement.volume = OpenStudio::convert(zone.getString(8).get.to_f,"m^3","ft^3").get # Volume {m3}
        space_unfinished_basement.coord_z = OpenStudio::convert(zone.getString(4).get.to_f,"m^3","ft^3").get # Z Origin {m}
      elsif zone_name == selected_ufbsmt
        crawlspace.height = OpenStudio::convert(zone.getString(7).get.to_f,"m","ft").get # Ceiling Height {m}
        crawlspace.area = OpenStudio::convert(zone.getString(9).get.to_f,"m","ft").get # Floor Area {m2}
        crawlspace.volume = OpenStudio::convert(zone.getString(8).get.to_f,"m^3","ft^3").get # Volume {m3}
        crawlspace.coord_z = OpenStudio::convert(zone.getString(4).get.to_f,"m^3","ft^3").get # Z Origin {m}
        ...
        unfinished_attic.area = OpenStudio::convert(zone.getString(9).get.to_f,"m","ft").get # Floor Area {m2}
        unfinished_attic.volume = OpenStudio::convert(zone.getString(8).get.to_f,"m^3","ft^3").get # Volume {m3}
        unfinished_attic.coord_z = OpenStudio::convert(zone.getString(4).get.to_f,"m^3","ft^3").get # Z Origin {m}
      end
    end

    # temp code
    geometry.num_bedrooms = 3.0 # tk get this
    geometry.finished_floor_area = 1200.0 # tk get this
    ...
    nv, schedules = sim._processNaturalVentilation(nv, living_space, wind_speed, si, schedules)
