...
class ResidentialHotWaterFixturesTest < MiniTest::Test
  ...
  def test_new_construction_standard
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = {"OtherEquipmentDefinition"=>3, "OtherEquipment"=>3, "WaterUseEquipmentDefinition"=>3, "WaterUseEquipment"=>3, "ScheduleVariableInterval"=>3, "ScheduleConstant"=>3}
  ...
  def test_new_construction_varying_mults
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"OtherEquipmentDefinition"=>2, "OtherEquipment"=>2, "WaterUseEquipmentDefinition"=>2, "WaterUseEquipment"=>2, "ScheduleVariableInterval"=>2, "ScheduleConstant"=>2}
  ...
  def test_retrofit_replace
    ...
    args_hash["sink_mult"] = 0.5
    args_hash["bath_mult"] = 1.5
    expected_num_del_objects = {"OtherEquipmentDefinition"=>3, "OtherEquipment"=>3, "WaterUseEquipmentDefinition"=>3, "WaterUseEquipment"=>3, "ScheduleVariableInterval"=>3, "ScheduleConstant"=>3}
    expected_num_new_objects = {"OtherEquipmentDefinition"=>2, "OtherEquipment"=>2, "WaterUseEquipmentDefinition"=>2, "WaterUseEquipment"=>2, "ScheduleVariableInterval"=>2, "ScheduleConstant"=>2}
    expected_values = {"Annual_kwh"=>107.7, "HotWater_gpd"=>23, "Space"=>args_hash["space"]}
  ...
  def test_single_family_attached_new_construction
    ...
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = {"OtherEquipmentDefinition"=>num_units*3, "OtherEquipment"=>num_units*3, "WaterUseEquipmentDefinition"=>num_units*3, "WaterUseEquipment"=>num_units*3, "ScheduleVariableInterval"=>num_units*3, "ScheduleConstant"=>num_units*3}
