...
class ProcessConstructionsCeilingsRoofsSheathingTest < MiniTest::Test
  ...
  def osm_geo_unfinished_attic_layers
    return "2000sqft_2story_SL_FA_AllLayersButRoofSheathing.osm"
  end
  ...
  def test_add_plywood
    ...
    expected_values = {"LayerThickness"=>0.01905, "LayerConductivity"=>0.1154577, "LayerDensity"=>512.64, "LayerSpecificHeat"=>1214.23, "LayerIndex"=>0}
  ...
  def test_add_plywood_and_r10
    ...
    expected_values = {"LayerThickness"=>0.01905+0.0508, "LayerConductivity"=>0.1154577+0.02885, "LayerDensity"=>512.64+32.04, "LayerSpecificHeat"=>1214.23+1214.23, "LayerIndex"=>0+1}
    _test_measure(osm_geo_unfinished_attic, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_add_plywood_and_r10_to_layers_and_remove
    ...
    expected_num_new_objects = {"Material"=>2, "Construction"=>1}
    expected_values = {"LayerThickness"=>0.01905+0.0508, "LayerConductivity"=>0.1154577+0.02885, "LayerDensity"=>512.64+32.04, "LayerSpecificHeat"=>1214.23+1214.23, "LayerIndex"=>1+2}
