...
class ResidentialHotWaterHeaterTankPropaneTest < MiniTest::Test
  ...
  def test_new_construction_standard
    ...
    expected_values = {"TankVolume"=>40, "InputCapacity"=>13.78, "ThermalEfficiency"=>0.771, "TankUA"=>7.790, "Setpoint"=>125, "OnCycle"=>0, "OffCycle"=>0}
  ...
  def test_new_construction_premium
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"WaterHeaterMixed"=>1, "PlantLoop"=>1, "PumpVariableSpeed"=>1, "ScheduleRuleset"=>2}
    expected_values = {"TankVolume"=>40, "InputCapacity"=>13.78, "ThermalEfficiency"=>0.786, "TankUA"=>4.404, "Setpoint"=>125, "OnCycle"=>140, "OffCycle"=>1}
    _test_measure(osm_geo_beds_loc, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 1)
  end
  ...
  def test_new_construction_standard_setpoint_130
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"WaterHeaterMixed"=>1, "PlantLoop"=>1, "PumpVariableSpeed"=>1, "ScheduleRuleset"=>2}
    expected_values = {"TankVolume"=>40, "InputCapacity"=>13.78, "ThermalEfficiency"=>0.771, "TankUA"=>7.790, "Setpoint"=>130, "OnCycle"=>0, "OffCycle"=>0}
    _test_measure(osm_geo_beds_loc, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 1)
  end
  ...
  def test_new_construction_standard_volume_30
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"WaterHeaterMixed"=>1, "PlantLoop"=>1, "PumpVariableSpeed"=>1, "ScheduleRuleset"=>2}
    expected_values = {"TankVolume"=>30, "InputCapacity"=>13.78, "ThermalEfficiency"=>0.771, "TankUA"=>7.790, "Setpoint"=>125, "OnCycle"=>0, "OffCycle"=>0}
    _test_measure(osm_geo_beds_loc, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 1)
  end
  ...
  def test_retrofit_replace
    ...
    expected_values = {"TankVolume"=>40, "InputCapacity"=>13.78, "ThermalEfficiency"=>0.786, "TankUA"=>4.404, "Setpoint"=>130, "OnCycle"=>140, "OffCycle"=>1}
  ...
  def test_multifamily_new_construction
    ...
    expected_values = {"TankVolume"=>120, "InputCapacity"=>41.33, "ThermalEfficiency"=>2.313, "TankUA"=>23.37, "Setpoint"=>375, "OnCycle"=>0, "OffCycle"=>0}
  ...
  def test_multifamily_new_construction_mult_draw_profiles
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"WaterHeaterMixed"=>num_units, "PlantLoop"=>num_units, "PumpVariableSpeed"=>num_units, "ScheduleRuleset"=>2*num_units}
    expected_values = {"TankVolume"=>480, "InputCapacity"=>165.3, "ThermalEfficiency"=>9.255, "TankUA"=>93.48, "Setpoint"=>1500, "OnCycle"=>0, "OffCycle"=>0}
  ...
  def test_multifamily_retrofit_replace
    ...
    expected_values = {"TankVolume"=>120, "InputCapacity"=>41.33, "ThermalEfficiency"=>2.358, "TankUA"=>13.212, "Setpoint"=>375, "OnCycle"=>420, "OffCycle"=>3}
  ...
  def _test_measure(osm_file_or_model, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, num_infos=0, num_warnings=0)
    ...
    assert_in_epsilon(Waterheater.calc_actual_tankvol(expected_values["TankVolume"], Constants.FuelTypePropane, Constants.WaterHeaterTypeTank), actual_values["TankVolume"], 0.01)
