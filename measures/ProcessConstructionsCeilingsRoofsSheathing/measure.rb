...
# start the measure
class SetResidentialRooflSheathing < OpenStudio::Ruleset::ModelUserScript

  # human readable name
  def name
    return "Set Residential Roof Sheathing"
  end
...
SetResidentialRooflSheathing.new.registerWithApplication
