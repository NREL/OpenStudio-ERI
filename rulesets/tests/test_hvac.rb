...
class ERIHVACtest < Minitest::Test
    ...
    _eri_versions.each do |eri_version|
      _test_ruleset(hpxml_name, eri_version).each do |(run_type, calc_type), hpxml_bldg|
        ...
        if run_type == RunType::CO2e # All-electric
          _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 1.0, frac_load_cool: 0.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values }])
        else
        ...
        _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 1.0, dse: _dse(calc_type), **hvac_iq_values }])
      end
    end
  end
      ...
      _eri_versions.each do |eri_version|
        _test_ruleset(hpxml_name, eri_version).each do |(_run_type, calc_type), hpxml_bldg|
          if [CalcType::RatedHome].include? calc_type
            ...
            _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 1.0, frac_load_cool: 1.0, compressor_temp: compressor_temp, backup_temp: backup_temp, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values }])
          else
            hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
            _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 1.0, frac_load_cool: 1.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values }])
          end
        end
      end
    end
      ...
      _eri_versions.each do |eri_version|
        _test_ruleset(hpxml_name, eri_version).each do |(_run_type, calc_type), hpxml_bldg|
          if [CalcType::RatedHome].include? calc_type
            ...
            _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpMiniSplit, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeVariableSpeed, hspf: 10, seer: 19, frac_load_heat: 1.0, frac_load_cool: 1.0, compressor_temp: -20.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values }])
          else
            hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
            _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 1.0, frac_load_cool: 1.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values }])
          end
      ...
      _eri_versions.each do |eri_version|
        _test_ruleset(hpxml_name, eri_version).each do |(_run_type, calc_type), hpxml_bldg|
          if [CalcType::RatedHome].include? calc_type
            ...
            _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpGroundToAir, fuel: HPXML::FuelTypeElectricity, eer: 16.6, cop: 3.6, frac_load_heat: 1.0, frac_load_cool: 1.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, pump_w_per_ton: 100, **hvac_iq_values }])
          else
            hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
            _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 1.0, frac_load_cool: 1.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values }])
          end
        ...
        _test_ruleset(hpxml_name, eri_version).each do |(run_type, calc_type), hpxml_bldg|
          if [CalcType::RatedHome].include? calc_type
            ...
            if run_type == RunType::CO2e # All-electric
              ...
              _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 1.0, frac_load_cool: 1.0, dse: _dse(calc_type), compressor_temp: compressor_temp, backup_temp: backup_temp, backup_fuel: HPXML::FuelTypeNaturalGas, backup_eff: 0.78, **hvac_iq_values }])
            end
          end
        end
      end
    ...
    hpxml_names.each do |hpxml_name|
      _eri_versions.each do |eri_version|
        _test_ruleset(hpxml_name, eri_version).each do |(_run_type, calc_type), hpxml_bldg|
          if [CalcType::RatedHome].include? calc_type
            hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
            _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 1.0, **hvac_iq_values }])
          else
            hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
            _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 1.0, dse: _dse(calc_type), **hvac_iq_values }])
          end
  ...
  def test_room_air_conditioner_and_ptac
    ...
    hpxml_names.each do |hpxml_name|
      ...
      _eri_versions.each do |eri_version|
        _test_ruleset(hpxml_name, eri_version).each do |(_run_type, calc_type), hpxml_bldg|
          if [CalcType::RatedHome].include? calc_type
            _check_cooling_system(hpxml_bldg, [{ systype: systype, fuel: HPXML::FuelTypeElectricity, eer: eer, ceer: ceer, frac_load: 1.0, comptype: HPXML::HVACCompressorTypeSingleStage }])
          else
            hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
            _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 1.0, dse: _dse(calc_type), **hvac_iq_values }])
          end
  ...
  def test_room_air_conditioner_and_ptac_with_heating
    ...
    hpxml_names.each do |hpxml_name|
      ...
      _eri_versions.each do |eri_version|
        _test_ruleset(hpxml_name, eri_version).each do |(_run_type, calc_type), hpxml_bldg|
          if [CalcType::RatedHome].include? calc_type
            _check_cooling_system(hpxml_bldg, [{ systype: systype, fuel: HPXML::FuelTypeElectricity, eer: eer, frac_load: 1.0, comptype: HPXML::HVACCompressorTypeSingleStage,
  ...
  def test_room_air_conditioner_and_ptac_with_heating_gas
    ...
    _eri_versions.each do |eri_version|
      _test_ruleset(hpxml_name, eri_version).each do |(run_type, calc_type), hpxml_bldg|
        if [CalcType::RatedHome].include? calc_type
          _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypePTAC, fuel: HPXML::FuelTypeElectricity, eer: 10.7, frac_load: 1.0, comptype: HPXML::HVACCompressorTypeSingleStage,
  ...
  def test_room_air_conditioner_with_reverse_cycle_and_pthp
    ...
    hpxml_names.each do |hpxml_name|
      ...
      _eri_versions.each do |eri_version|
        _test_ruleset(hpxml_name, eri_version).each do |(_run_type, calc_type), hpxml_bldg|
          if [CalcType::RatedHome].include? calc_type
            _check_heat_pump(hpxml_bldg, [{ systype: systype, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, cop: 3.6, eer: 11.4, frac_load_heat: 1.0, frac_load_cool: 1.0, compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0 }])
          else
            hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
            _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 1.0, frac_load_cool: 1.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values }])
          end
      ...
      _eri_versions.each do |eri_version|
        _test_ruleset(hpxml_name, eri_version).each do |(_run_type, calc_type), hpxml_bldg|
          if [CalcType::RatedHome].include? calc_type
            ...
            _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeMiniSplitAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeVariableSpeed, seer: 19, frac_load: 1.0, **hvac_iq_values }])
          else
            hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
            _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 1.0, dse: _dse(calc_type), **hvac_iq_values }])
          end
    ...
    _eri_versions.each do |eri_version|
      _test_ruleset(hpxml_name, eri_version).each do |(run_type, calc_type), hpxml_bldg|
        if [CalcType::RatedHome].include? calc_type
          ...
          _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 0.1333, **hvac_iq_values },
                                             { systype: HPXML::HVACTypeRoomAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, eer: 8.5, frac_load: 0.1333 },
                                             { systype: HPXML::HVACTypePTAC, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, eer: 10.7, frac_load: 0.1333 }])
          ...
          _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.2, compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                        { systype: HPXML::HVACTypeHeatPumpGroundToAir, fuel: HPXML::FuelTypeElectricity, eer: 16.6, cop: 3.6, frac_load_heat: 0.1, frac_load_cool: 0.2, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, pump_w_per_ton: 100, **gshp_hvac_iq_values },
                                        { systype: HPXML::HVACTypeHeatPumpMiniSplit, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeVariableSpeed, hspf: 10, seer: 19, frac_load_heat: 0.1, frac_load_cool: 0.2, compressor_temp: -20.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **mshp_hvac_iq_values }])
        else
          hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
          if run_type == RunType::CO2e # All-electric
            _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                          { systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.1333, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                          { systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                          { systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                          { systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                          { systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                          { systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                          { systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.2, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                          { systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.2, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                          { systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.1, frac_load_cool: 0.2, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values }])
            _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 0.1333, dse: _dse(calc_type), **hvac_iq_values },
                                               { systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 0.1333, dse: _dse(calc_type), **hvac_iq_values }])
          else
  ...
  def test_partial_hvac
    ...
    _eri_versions.each do |eri_version|
      _test_ruleset(hpxml_name, eri_version).each do |(run_type, calc_type), hpxml_bldg|
        if [CalcType::RatedHome].include? calc_type
          hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
          _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 0.3, **hvac_iq_values },
                                             { systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 0.7, dse: _dse(calc_type), **hvac_iq_values }])
          ...
          hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
          if run_type == RunType::CO2e # All-electric
            _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.2, frac_load_cool: 0.3, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values },
                                          { systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 0.8, frac_load_cool: 0.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values }])
            _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 0.7, dse: _dse(calc_type), **hvac_iq_values }])
          else
            _check_heating_system(hpxml_bldg, [{ systype: HPXML::HVACTypeFurnace, fuel: HPXML::FuelTypeNaturalGas, eff: 0.78, frac_load: 0.2, dse: _dse(calc_type), **hvac_iq_values },
                                               { systype: HPXML::HVACTypeFurnace, fuel: HPXML::FuelTypeNaturalGas, eff: 0.78, frac_load: 0.8, dse: _dse(calc_type), **hvac_iq_values }])
            _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 0.3, dse: _dse(calc_type), **hvac_iq_values },
                                               { systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 0.7, dse: _dse(calc_type), **hvac_iq_values }])
          end
        end
      end
  ...
  def test_shared_ground_loop_ground_source_heat_pump
    ...
    _eri_versions.each do |eri_version|
      _test_ruleset(hpxml_name, eri_version).each do |(_run_type, calc_type), hpxml_bldg|
        if [CalcType::RatedHome].include? calc_type
          hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.375)
          _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpGroundToAir, fuel: HPXML::FuelTypeElectricity, eer: 16.6, cop: 3.6, frac_load_heat: 1.0, frac_load_cool: 1.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, pump_w_per_ton: 0, num_units_served: 6, shared_loop_watts: 600, **hvac_iq_values }])
        else
          hvac_iq_values = _get_default_hvac_iq_values(eri_version, 0.5)
          _check_heat_pump(hpxml_bldg, [{ systype: HPXML::HVACTypeHeatPumpAirToAir, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, hspf: 7.7, seer: 13, eer: 11, frac_load_heat: 1.0, frac_load_cool: 1.0, dse: _dse(calc_type), compressor_temp: 0.0, backup_temp: 40.0, backup_fuel: HPXML::FuelTypeElectricity, backup_eff: 1.0, **hvac_iq_values }])
        end
  ...
  def test_dse
    ...
    _test_ruleset(hpxml_name, 'latest').each do |(run_type, calc_type), hpxml_bldg|
      if [CalcType::RatedHome].include? calc_type
        ...
        _check_cooling_system(hpxml_bldg, [{ systype: HPXML::HVACTypeCentralAirConditioner, fuel: HPXML::FuelTypeElectricity, comptype: HPXML::HVACCompressorTypeSingleStage, seer: 13, eer: 11, frac_load: 1.0, dse: 0.7, **hvac_iq_values }])
