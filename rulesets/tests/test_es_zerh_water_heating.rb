  ...
  def test_water_heating_tank_elec
    [*ESConstants.AllVersions, *ZERHConstants.AllVersions].each do |program_version|
      ...
      if [ESConstants.MFNationalVer1_0, ESConstants.MFNationalVer1_1].include? program_version
        ...
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeHeatPump, fuel: HPXML::FuelTypeElectricity, location: HPXML::LocationLivingSpace, tank_vol: 40, uef: 2.57, n_units_served: 1 }])
  ...
  def test_water_heating_tank_gas
    [*ESConstants.AllVersions, *ZERHConstants.AllVersions].each do |program_version|
      ...
      if [ESConstants.MFNationalVer1_0, ESConstants.MFNationalVer1_1, ZERHConstants.Ver1].include? program_version
        ...
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeStorage, fuel: HPXML::FuelTypeNaturalGas, location: HPXML::LocationLivingSpace, tank_vol: 30, uef: 0.95, n_units_served: 1 }])
      elsif program_version == ESConstants.SFPacificVer3_0
  ...
  def test_water_heating_tank_oil
    [*ESConstants.AllVersions, *ZERHConstants.AllVersions].each do |program_version|
      ...
      if [ESConstants.MFNationalVer1_0, ESConstants.MFNationalVer1_1, ZERHConstants.Ver1].include? program_version
        ...
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeStorage, fuel: HPXML::FuelTypeOil, location: HPXML::LocationLivingSpace, tank_vol: 50, uef: 0.95, n_units_served: 1 }])
      elsif program_version == ESConstants.SFPacificVer3_0
  ...
  def test_water_heating_tank_heat_pump
    [*ESConstants.AllVersions, *ZERHConstants.AllVersions].each do |program_version|
      ...
      if [ESConstants.MFNationalVer1_0, ESConstants.MFNationalVer1_1].include? program_version
        ...
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeHeatPump, fuel: HPXML::FuelTypeElectricity, location: HPXML::LocationLivingSpace, tank_vol: 50, uef: 2.57, n_units_served: 1 }])
      elsif program_version == ESConstants.SFNationalVer3_2
  ...
  def test_water_heating_tankless_electric
    [*ESConstants.AllVersions, *ZERHConstants.AllVersions].each do |program_version|
      ...
      if [ESConstants.MFNationalVer1_0, ESConstants.MFNationalVer1_1].include? program_version
        ...
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeHeatPump, fuel: HPXML::FuelTypeElectricity, location: HPXML::LocationLivingSpace, tank_vol: 60, uef: 2.57, n_units_served: 1 }])
      elsif program_version == ESConstants.SFNationalVer3_2
  ...
  def test_water_heating_tankless_gas
    [*ESConstants.AllVersions, *ZERHConstants.AllVersions].each do |program_version|
      ...
      if [ESConstants.MFNationalVer1_0, ESConstants.MFNationalVer1_1].include? program_version
        ...
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeStorage, fuel: HPXML::FuelTypeNaturalGas, location: HPXML::LocationLivingSpace, tank_vol: 40, uef: 0.95, n_units_served: 1 }])
      elsif [ESConstants.SFNationalVer3_2, ESConstants.MFNationalVer1_2].include? program_version
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeTankless, fuel: HPXML::FuelTypeNaturalGas, location: HPXML::LocationLivingSpace, uef: 0.90, n_units_served: 1 }])
      else
  ...
  def test_multiple_water_heating
    [*ESConstants.AllVersions, *ZERHConstants.AllVersions].each do |program_version|
      ...
      if [ESConstants.MFNationalVer1_0, ESConstants.MFNationalVer1_1].include? program_version
        ...
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeHeatPump, fuel: HPXML::FuelTypeElectricity, frac_load: 0.2, location: HPXML::LocationLivingSpace, tank_vol: 40, uef: 2.57, n_units_served: 1 },
                                    { whtype: HPXML::WaterHeaterTypeStorage, fuel: HPXML::FuelTypeNaturalGas, frac_load: 0.2, location: HPXML::LocationLivingSpace, tank_vol: 50, uef: 0.95, n_units_served: 1 },
                                    { whtype: HPXML::WaterHeaterTypeHeatPump, fuel: HPXML::FuelTypeElectricity, frac_load: 0.2, location: HPXML::LocationLivingSpace, tank_vol: 80, uef: 2.57, n_units_served: 1 },
                                    { whtype: HPXML::WaterHeaterTypeHeatPump, fuel: HPXML::FuelTypeElectricity, frac_load: 0.2, location: HPXML::LocationLivingSpace, tank_vol: 60, uef: 2.57, n_units_served: 1 },
                                    { whtype: HPXML::WaterHeaterTypeStorage, fuel: HPXML::FuelTypeNaturalGas, frac_load: 0.1, location: HPXML::LocationLivingSpace, tank_vol: 40, uef: 0.95, n_units_served: 1 },
                                    { whtype: HPXML::WaterHeaterTypeStorage, fuel: HPXML::FuelTypeNaturalGas, frac_load: 0.1, location: HPXML::LocationLivingSpace, tank_vol: 50, uef: 0.95, n_units_served: 1 }])
      elsif program_version == ESConstants.SFNationalVer3_2
  ...
  def test_indirect_water_heating
    [*ESConstants.AllVersions, *ZERHConstants.AllVersions].each do |program_version|
      ...
      if [ESConstants.MFNationalVer1_0, ESConstants.MFNationalVer1_1, ZERHConstants.Ver1].include? program_version
        ...
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeStorage, fuel: HPXML::FuelTypeNaturalGas, location: HPXML::LocationLivingSpace, tank_vol: 50, uef: 0.95, n_units_served: 1 }])
      elsif program_version == ESConstants.SFPacificVer3_0
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeStorage, fuel: HPXML::FuelTypeNaturalGas, location: HPXML::LocationLivingSpace, tank_vol: 50, ef: 0.80, n_units_served: 1 }])
      elsif [ESConstants.SFOregonWashingtonVer3_2, ESConstants.MFOregonWashingtonVer1_2].include? program_version
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeTankless, fuel: HPXML::FuelTypeNaturalGas, location: HPXML::LocationLivingSpace, ef: 0.91, n_units_served: 1 }])
  ...
  def test_water_heating_recirc
    [*ESConstants.AllVersions, *ZERHConstants.AllVersions].each do |program_version|
      ...
      if [ESConstants.MFNationalVer1_0, ESConstants.MFNationalVer1_1].include? program_version
        ...
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeHeatPump, fuel: HPXML::FuelTypeElectricity, frac_load: 1.0, location: HPXML::LocationLivingSpace, tank_vol: 40, uef: 2.57, n_units_served: 1 }])
      elsif program_version == ESConstants.SFNationalVer3_2
  ...
  def test_shared_water_heating_recirc
    [*ESConstants.AllVersions, *ZERHConstants.AllVersions].each do |program_version|
      ...
      if [ESConstants.SFNationalVer3_0, ESConstants.SFNationalVer3_1, ESConstants.SFFloridaVer3_1].include? program_version
        ...
        _check_water_heater(hpxml, [{ whtype: HPXML::WaterHeaterTypeStorage, fuel: HPXML::FuelTypeNaturalGas, location: HPXML::LocationLivingSpace, tank_vol: 120.0, uef: 0.95, n_units_served: 6 }])
