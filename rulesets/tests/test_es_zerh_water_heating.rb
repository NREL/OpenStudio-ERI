...
class EnergyStarZeroEnergyReadyHomeWaterHeatingTest < MiniTest::Test
  ...
  def is_low_flow(program_version)
    if [ESConstants.SFNationalVer3_0, ESConstants.SFNationalVer3_1, ESConstants.SFPacificVer3_0,
        ESConstants.SFFloridaVer3_1, ESConstants.SFOregonWashingtonVer3_2,
