...
<sch:schema xmlns:sch='http://purl.oclc.org/dsdl/schematron'>
  ...
  <sch:pattern>
    ...
    <sch:rule context='/h:HPXML/h:SoftwareInfo/h:extension/h:DENHCalculation/h:Version'>
      <sch:assert role='ERROR' test='text()="1.0" or text()="SF_2.0" or text()="MF_2.0"'>Expected SoftwareInfo/extension/DENHCalculation/Version to be '1.0' or 'SF_2.0' or 'MF_2.0'</sch:assert>
    </sch:rule>
  </sch:pattern>
