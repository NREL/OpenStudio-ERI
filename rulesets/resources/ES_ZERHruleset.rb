...
module ES_ZERH_Ruleset
  ...
  def self.set_enclosure_floors_reference(orig_bldg, new_bldg)
    ...
    orig_bldg.floors.each do |orig_floor|
      ...
      if orig_floor.is_thermal_boundary && (not (multifamily_adjacent_locations - [HPXML::LocationOtherMultifamilyBufferSpace, HPXML::LocationOtherNonFreezingSpace]).include?(orig_floor.exterior_adjacent_to))
