  ...
  def self.run_validator(hpxml_doc)
    ...
    requirements = {
      ...
      '/HPXML/Building/BuildingDetails/Systems/HVAC/HVACDistribution/DistributionSystemType/AirDistribution' => {
        '[extension/DuctLeakageTestingExemption="true"] | DuctLeakageMeasurement[DuctType="supply"]/DuctLeakage[Units="CFM25"][TotalOrToOutside="to outside" or TotalOrToOutside="total"]/Value' => one,
        '[extension/DuctLeakageTestingExemption="true"] | DuctLeakageMeasurement[DuctType="return"]/DuctLeakage[Units="CFM25"][TotalOrToOutside="to outside" or TotalOrToOutside="total"]/Value' => zero_or_one,
