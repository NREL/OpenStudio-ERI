  ...
  def test_mech_vent_none
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 26.8, hours: 24, power: 0.0 }] # Should have airflow but not fan energy
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = []
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
        end
        _check_mech_vent(hpxml, values)
      end
    end
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 37.0, hours: 24, power: 0.0 }] # Should have airflow but not fan energy
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = []
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 34.0, hours: 24, power: 42.0 }]
        end
        _check_mech_vent(hpxml, values)
      end
    end
  ...
  def test_mech_vent_attached_or_multifamily
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 50.6, hours: 24, power: 0.0 }] # Should have airflow but not fan energy
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = []
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 70.6, hours: 24, power: 49.4 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 32.1, hours: 24, power: 55.0 }]
        end
        _check_mech_vent(hpxml, values)
      end
    end
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 57.0, hours: 24, power: 0.0 }] # Should have airflow but not fan energy
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = []
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 102.0, hours: 24, power: 71.4 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 102.0, hours: 24, power: 71.4 }]
        end
        _check_mech_vent(hpxml, values)
  ...
  def test_mech_vent_exhaust
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 26.8, hours: 24, power: 34.8 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 110.0, hours: 24, power: 30.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 37.0, hours: 24, power: 26.4 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 110.0, hours: 24, power: 30.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 110.0, hours: 21.7, power: 30.0 }] # Increased fan power
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 110.0, hours: 16.4, power: 30.0 }] # Increased fan power
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 34.0, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 99.6, hours: 24, power: 34.8 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 75.4, hours: 24, power: 26.4 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 34.0, hours: 24, power: 42.0 }]
  ...
  def test_mech_vent_exhaust_unmeasured_airflow_rate
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 26.8, hours: 24, power: 0.1 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 15.0, hours: 24, power: 30.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 75.4, hours: 24, power: 30.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 34.0, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 15.0, hours: 24, power: 5.25 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeSupply, flowrate: 110.0, hours: 24, power: 30.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
  ...
  def test_mech_vent_balanced
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 26.8, hours: 24, power: 52.8 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 110.0, hours: 24, power: 60.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 37.0, hours: 24, power: 52.8 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 110.0, hours: 24, power: 60.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
  ...
  def test_mech_vent_erv
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 26.8, hours: 24, power: 75.4 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeERV, flowrate: 110.0, hours: 24, power: 60.0, sre: 0.72, tre: 0.48 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 37.0, hours: 24, power: 75.4 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeERV, flowrate: 110.0, hours: 24, power: 60.0, sre: 0.72, tre: 0.48 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeERV, flowrate: 110.0, hours: 24, power: 60.0, asre: 0.79, atre: 0.526 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeHRV, flowrate: 110.0, hours: 24, power: 60.0, sre: 0.72 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeHRV, flowrate: 110.0, hours: 24, power: 60.0, asre: 0.79 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeCFIS, flowrate: 330.0, hours: 8, power: 300.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeCFIS, flowrate: 45.0, hours: 8, power: 400.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 60.0, hours: 24, power: 42.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 8.5, hours: 24, power: 42.0 }]
  ...
  def test_mech_vent_multiple
    ...
    calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeSupply, flowrate: 50.0, hours: 18.1, power: 25.0 },
    ...
    calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 75.4, hours: 24, power: 37.7 },
    ...
    calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 50.0, hours: 24, power: 25.0 },
    ...
    calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 37.0, hours: 24, power: 39.6 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeExhaust, flowrate: 50.0, hours: 18.1, power: 25.0 },
    ...
    calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 37.0, hours: 24, power: 36.5 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeSupply, flowrate: 45.0, hours: 8, power: 25.0 },
    ...
    calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 37.0, hours: 24, power: 31.5 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeSupply, flowrate: 45.0, hours: 8, power: 25.0 },
  ...
  def test_mech_vent_shared
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 50.6, hours: 24, power: 19.7 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeSupply, flowrate: 800.0, hours: 24, power: 240.0, in_unit_flowrate: 80.0, frac_recirc: 0.5, has_preheat: true, has_precool: true },
                    { fantype: HPXML::MechVentTypeExhaust, flowrate: 72.0, hours: 24, power: 26.0 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentDesign
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 70.6, hours: 24, power: 49.4 }]
        elsif calc_type == Constants.CalcTypeERIIndexAdjustmentReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 32.1, hours: 24, power: 54.9 }]
        end
        _check_mech_vent(hpxml, values)
      end
    end
    ...
    calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeSupply, flowrate: 800.0, hours: 24, power: 800.0, in_unit_flowrate: 80.0, frac_recirc: 0.5, has_preheat: true, has_precool: true },
                    { fantype: HPXML::MechVentTypeExhaust, flowrate: 72.0, hours: 24, power: 26.0 }]
        end
        _check_mech_vent(hpxml, values)
      end
  ...
  def test_mech_vent_shared_unmeasured_airflow_rate
    ...
    calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        hpxml = _test_measure(hpxml_name, calc_type, is_co2_calc)
        if calc_type == Constants.CalcTypeERIReferenceHome
          values = [{ fantype: HPXML::MechVentTypeBalanced, flowrate: 50.6, hours: 24, power: 17.9 }]
        elsif calc_type == Constants.CalcTypeERIRatedHome
          values = [{ fantype: HPXML::MechVentTypeSupply, flowrate: 800.0, hours: 24, power: 240.0, in_unit_flowrate: 30.0, frac_recirc: 0.5, has_preheat: true, has_precool: true },
                    { fantype: HPXML::MechVentTypeExhaust, flowrate: 72.0, hours: 24, power: 26.0 }]
        end
        _check_mech_vent(hpxml, values)
      end
    ...
    calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIReferenceHome
          ...
          values = [{ fantype: HPXML::MechVentTypeSupply, flowrate: 800.0, hours: 24, power: 800.0, in_unit_flowrate: 30.0, frac_recirc: 0.5, has_preheat: true, has_precool: true },
                    { fantype: HPXML::MechVentTypeExhaust, flowrate: 72.0, hours: 24, power: 26.0 }]
        end
        _check_mech_vent(hpxml, values)
      end
    ...
    _all_calc_types.each do |calc_type|
      _get_co2_calcs(calc_type).each do |is_co2_calc|
        ...
        if calc_type == Constants.CalcTypeERIRatedHome
          values = { flowrate: 4500, power: 300 }
        else
          values = {}
        end
        _check_whf(hpxml, values)
      end
    end
  end
